...
for i, line in enumerate(open("/Users/MSR/Desktop/stackoverflow-neo4j/extracted/Users.xml")):
    line = line.strip()
    try:
...
for i, line in enumerate(open("/Users/MSR/Desktop/stackoverflow-neo4j/extracted/Tags.xml")):
    line = line.strip()
    try:
        if line.startswith("<row"):
            el = xmltodict.parse(line)['row']
